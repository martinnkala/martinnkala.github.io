...
def main():
    ...
    if vin in vehicles:
        ...
        car_specifics = vehicles

        # Print the manufacturer, model, and color of the vehicle.
        # Don't print the year, engine design, or displacement.
        
        manufacturer_var = vehicles[vin][MANUFACTURER_INDEX]
        model_var = vehicles[vin][MODEL_INDEX]
        color_var = vehicles[vin][COLOR_INDEX]
        print(f"{manufacturer_var} {model_var} {color_var}")
