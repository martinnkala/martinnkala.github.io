const requestURL =
    "https://api.openweathermap.org/data/2.5/weather?id=5604473&appid=c11a593471720ea004ec8126ba37b91b&units=imperial";
fetch(requestURL)
...
const fetchurl =
    "https://api.openweathermap.org/data/2.5/forecast?id=5604473&appid=c11a593471720ea004ec8126ba37b91b&units=imperial";
fetch(fetchurl)
    .then((response) => {
        return response.json();
    })
